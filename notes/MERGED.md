...
1. `chapter1/01-现代Agent=LLM+上下文+工具/01-观察空间与动作空间：模型与世界的接口.md`
2. `chapter1/01-现代Agent=LLM+上下文+工具/02-工具：Agent的手脚.md`
3. `chapter1/01-现代Agent=LLM+上下文+工具/03-LLM：Agent的大脑.md`
4. `chapter1/01-现代Agent=LLM+上下文+工具/04-上下文：Agent的眼睛.md`
5. `chapter1/01-现代Agent=LLM+上下文+工具/05-ReAct循环.md`
6. `chapter1/01-现代Agent=LLM+上下文+工具/README.md`
7. `chapter1/02-Harness工程：模型之外的竞争力/01-从提示工程到Loop工程：工程范式的演进.md`
8. `chapter1/02-Harness工程：模型之外的竞争力/02-构建有效Agent的核心原则.md`
9. `chapter1/02-Harness工程：模型之外的竞争力/03-如何选择模型.md`
10. `chapter1/02-Harness工程：模型之外的竞争力/04-编排模式：工作流与自主.md`
11. `chapter1/02-Harness工程：模型之外的竞争力/05-护栏与安全性.md`
12. `chapter1/02-Harness工程：模型之外的竞争力/06-Harness五要素与「构建」部分的对应.md`
13. `chapter1/02-Harness工程：模型之外的竞争力/README.md`
14. `chapter1/03-贯穿全书的设计模式/README.md`
15. `chapter2/01-上下文决定Agent能力上限/README.md`
16. `chapter2/02-Agent如何调用大模型/01-消息的四种角色.md`
17. `chapter2/02-Agent如何调用大模型/02-单轮对话.md`
18. `chapter2/02-Agent如何调用大模型/03-带工具调用的多轮交互.md`
19. `chapter2/02-Agent如何调用大模型/04-用代码实现Agent核心循环.md`
20. `chapter2/02-Agent如何调用大模型/05-从API视角看上下文构成.md`
21. `chapter2/02-Agent如何调用大模型/README.md`
22. `chapter2/03-KV-Cache友好的上下文设计/01-Chat-Template.md`
23. `chapter2/03-KV-Cache友好的上下文设计/02-KV-Cache原理与约束.md`
24. `chapter2/03-KV-Cache友好的上下文设计/03-KV-Cache与Prompt-Cache.md`
25. `chapter2/03-KV-Cache友好的上下文设计/04-缓存作为架构约束.md`
26. `chapter2/03-KV-Cache友好的上下文设计/05-KV-Cache可编辑与可组合.md`
27. `chapter2/03-KV-Cache友好的上下文设计/README.md`
28. `chapter2/04-提示工程优化系统提示词/01-语气与风格.md`
29. `chapter2/04-提示工程优化系统提示词/02-结构化提示.md`
30. `chapter2/04-提示工程优化系统提示词/03-流程驱动与规则堆砌.md`
31. `chapter2/04-提示工程优化系统提示词/04-业务规则细化.md`
32. `chapter2/04-提示工程优化系统提示词/05-Few-shot示例.md`
33. `chapter2/04-提示工程优化系统提示词/06-工具定义设计.md`
34. `chapter2/04-提示工程优化系统提示词/07-提示注入.md`
35. `chapter2/04-提示工程优化系统提示词/README.md`
36. `chapter2/05-动态提示词与Agent-Skills/01-Skills领域能力的可组合单元.md`
37. `chapter2/05-动态提示词与Agent-Skills/02-如何编写Skill.md`
38. `chapter2/05-动态提示词与Agent-Skills/03-Skills在上下文中的位置.md`
39. `chapter2/05-动态提示词与Agent-Skills/04-Skills与工具的关系.md`
40. `chapter2/05-动态提示词与Agent-Skills/README.md`
41. `chapter2/06-Agent状态栏/01-状态栏理论基础.md`
42. `chapter2/06-Agent状态栏/02-状态栏的构成.md`
43. `chapter2/06-Agent状态栏/03-状态栏在上下文中的位置.md`
44. `chapter2/06-Agent状态栏/04-状态更新与缓存代价.md`
45. `chapter2/06-Agent状态栏/README.md`
46. `chapter2/07-上下文压缩策略/01-为什么需要压缩.md`
47. `chapter2/07-上下文压缩策略/02-上下文学习的内部机制.md`
48. `chapter2/07-上下文压缩策略/03-压缩与KV-Cache.md`
49. `chapter2/07-上下文压缩策略/04-生产级分层压缩.md`
50. `chapter2/07-上下文压缩策略/05-压缩策略设计原则.md`
51. `chapter2/07-上下文压缩策略/06-隔离优于压缩.md`
52. `chapter2/07-上下文压缩策略/README.md`
53. `chapter3/01-用户记忆系统/01-记忆能力的评估：三层次框架.md`
54. `chapter3/01-用户记忆系统/02-记忆的层次结构.md`
55. `chapter3/01-用户记忆系统/03-用户记忆的四种存储格式.md`
56. `chapter3/01-用户记忆系统/04-进阶知识表示形态：可执行代码.md`
57. `chapter3/01-用户记忆系统/05-用户记忆的认知科学基础.md`
58. `chapter3/01-用户记忆系统/06-记忆框架案例.md`
59. `chapter3/01-用户记忆系统/07-记忆压缩与整理机制.md`
60. `chapter3/01-用户记忆系统/08-隐私保护：日志脱敏.md`
61. `chapter3/01-用户记忆系统/README.md`
62. `chapter3/02-RAG基础：构建Agent的知识获取管道/01-文档分块（Chunking）.md`
63. `chapter3/02-RAG基础：构建Agent的知识获取管道/02-稠密嵌入：从词汇关联到语义理解.md`
64. `chapter3/02-RAG基础：构建Agent的知识获取管道/03-稀疏嵌入：精确匹配的关键词检索.md`
65. `chapter3/02-RAG基础：构建Agent的知识获取管道/04-混合检索：两全其美的艺术.md`
66. `chapter3/02-RAG基础：构建Agent的知识获取管道/README.md`
67. `chapter3/03-超越扁平文本：知识的组织与检索/01-结构化索引：从信息检索到知识建模.md`
68. `chapter3/03-超越扁平文本：知识的组织与检索/02-文件系统范式：用目录结构组织知识.md`
69. `chapter3/03-超越扁平文本：知识的组织与检索/03-知识应该如何更新.md`
70. `chapter3/03-超越扁平文本：知识的组织与检索/04-智能体化RAG：将知识检索工具化的范式转变.md`
71. `chapter3/03-超越扁平文本：知识的组织与检索/05-RAG技巧：上下文感知检索.md`
72. `chapter3/03-超越扁平文本：知识的组织与检索/06-从数据集中提取深度知识：从信息检索到知识发现.md`
73. `chapter3/03-超越扁平文本：知识的组织与检索/07-前沿探索：多模态记忆.md`
74. `chapter3/03-超越扁平文本：知识的组织与检索/README.md`
75. `chapter4/01-工具的分类/README.md`
76. `chapter4/02-工具设计的通用原则/01-能力的表达形式：专用工具、通用执行器与Skill.md`
77. `chapter4/02-工具设计的通用原则/02-工具描述的艺术.md`
78. `chapter4/02-工具设计的通用原则/03-参数传递的保真性.md`
79. `chapter4/02-工具设计的通用原则/README.md`
80. `chapter4/03-工具生态：MCP与SkillHub/README.md`
81. `chapter4/04-工具太多怎么办：层次化组织与主动工具发现/01-层次化组织与按需加载.md`
82. `chapter4/04-工具太多怎么办：层次化组织与主动工具发现/02-模型原生的主动工具发现.md`
83. `chapter4/04-工具太多怎么办：层次化组织与主动工具发现/03-Skills：把工具发现变成“按需查阅”.md`
84. `chapter4/04-工具太多怎么办：层次化组织与主动工具发现/README.md`
85. `chapter4/05-感知工具/01-多模态感知.md`
86. `chapter4/05-感知工具/README.md`
87. `chapter4/06-执行工具/README.md`
88. `chapter4/07-协作工具/README.md`
89. `chapter5/01-CodingAgent/01-Coding是Agent的基础能力.md`
90. `chapter5/01-CodingAgent/02-案例：从Manus到OpenClaw——通用Agent的Coding内核.md`
91. `chapter5/01-CodingAgent/03-CodingAgent的整体流程.md`
92. `chapter5/01-CodingAgent/04-Harness工程在CodingAgent中的实践.md`
93. `chapter5/01-CodingAgent/05-故障与错误恢复.md`
94. `chapter5/01-CodingAgent/06-CodingAgent的实现技巧.md`
95. `chapter5/01-CodingAgent/07-CodingAgent中的搜索工具.md`
96. `chapter5/01-CodingAgent/08-CodingAgent中的文件编辑工具.md`
97. `chapter5/01-CodingAgent/09-CodingAgent的安全.md`
98. `chapter5/01-CodingAgent/README.md`
99. `chapter5/02-代码：通用Agent的元能力/01-代码作为思考工具.md`
100. `chapter5/02-代码：通用Agent的元能力/02-代码作为业务规则的约束.md`
101. `chapter5/02-代码：通用Agent的元能力/03-代码驱动的多媒体生成.md`
102. `chapter5/02-代码：通用Agent的元能力/04-代码作为系统适配器.md`
103. `chapter5/02-代码：通用Agent的元能力/05-代码作为生成式UI.md`
104. `chapter5/02-代码：通用Agent的元能力/06-代码创造代码：Agent自举.md`
105. `chapter5/02-代码：通用Agent的元能力/README.md`
106. `chapter6/01-模态与触发时机的扩展/README.md`
107. `chapter6/02-异步与事件驱动：当世界主动找上门/01-为什么需要异步.md`
108. `chapter6/02-异步与事件驱动：当世界主动找上门/02-OpenClaw的事件驱动机制实现.md`
109. `chapter6/02-异步与事件驱动：当世界主动找上门/03-事件触发工具.md`
110. `chapter6/02-异步与事件驱动：当世界主动找上门/04-用户沟通工具.md`
111. `chapter6/02-异步与事件驱动：当世界主动找上门/05-虚拟身份与隔离执行环境.md`
112. `chapter6/02-异步与事件驱动：当世界主动找上门/06-事件处理机制.md`
113. `chapter6/02-异步与事件驱动：当世界主动找上门/07-不支持原生异步时的兼容方案.md`
114. `chapter6/02-异步与事件驱动：当世界主动找上门/08-模型原生异步：GPT-6Astra.md`
115. `chapter6/02-异步与事件驱动：当世界主动找上门/09-从“能接收异步消息”到“可靠处理异步任务”.md`
116. `chapter6/02-异步与事件驱动：当世界主动找上门/README.md`
117. `chapter6/03-语音：最自然的人机接口/01-交互时序：从级联到全双工.md`
118. `chapter6/03-语音：最自然的人机接口/02-范式一·级联流水线（Cascading）.md`
119. `chapter6/03-语音：最自然的人机接口/03-范式二·端到端全模态模型（Omni）.md`
120. `chapter6/03-语音：最自然的人机接口/04-范式三·全双工交互模型.md`
121. `chapter6/03-语音：最自然的人机接口/05-认知时序：实时交互与深度思考.md`
122. `chapter6/03-语音：最自然的人机接口/06-更像人的语音合成.md`
123. `chapter6/03-语音：最自然的人机接口/README.md`
124. `chapter6/04-ComputerUse：GUI自动化Agent/01-动作空间设计.md`
125. `chapter6/04-ComputerUse：GUI自动化Agent/02-视觉定位（Grounding）.md`
126. `chapter6/04-ComputerUse：GUI自动化Agent/03-能看动画、能听声音的ComputerUseAgent.md`
127. `chapter6/04-ComputerUse：GUI自动化Agent/04-ComputerUse的世界模型.md`
128. `chapter6/04-ComputerUse：GUI自动化Agent/05-移动端：生态壁垒比技术更难.md`
129. `chapter6/04-ComputerUse：GUI自动化Agent/README.md`
130. `chapter6/05-机器人操作：以XLeRobot整理桌面为例/01-硬件与算法的分工.md`
131. `chapter6/05-机器人操作：以XLeRobot整理桌面为例/02-机器人控制的基本结构.md`
132. `chapter6/05-机器人操作：以XLeRobot整理桌面为例/03-长程规划与任务分解.md`
133. `chapter6/05-机器人操作：以XLeRobot整理桌面为例/04-VLA控制.md`
134. `chapter6/05-机器人操作：以XLeRobot整理桌面为例/05-VLA的局限.md`
135. `chapter6/05-机器人操作：以XLeRobot整理桌面为例/06-世界模型.md`
136. `chapter6/05-机器人操作：以XLeRobot整理桌面为例/07-从仿真环境到真实机器人.md`
137. `chapter6/05-机器人操作：以XLeRobot整理桌面为例/README.md`
138. `chapter7/01-一条评估任务的解剖：τ²-bench的telecom领域/01-任务定义的四个组成部分.md`
139. `chapter7/01-一条评估任务的解剖：τ²-bench的telecom领域/02-一次真实运行的轨迹.md`
140. `chapter7/01-一条评估任务的解剖：τ²-bench的telecom领域/README.md`
141. `chapter7/02-评估指标：成功的定义/01-技术奇观：用Pass@k看能力上限.md`
142. `chapter7/02-评估指标：成功的定义/02-业务可靠性：关注Pass^k.md`
143. `chapter7/02-评估指标：成功的定义/README.md`
144. `chapter7/03-评估环境/01-五个组成要素.md`
145. `chapter7/03-评估环境/02-人机交互型与工具调用型评估环境.md`
146. `chapter7/03-评估环境/README.md`
147. `chapter7/04-评估数据集的设计/01-基准设计的横向对照.md`
148. `chapter7/04-评估数据集的设计/02-验证器.md`
149. `chapter7/04-评估数据集的设计/03-任务的难度划分.md`
150. `chapter7/04-评估数据集的设计/04-数据泄漏防范.md`
151. `chapter7/04-评估数据集的设计/05-质量控制与长期维护.md`
152. `chapter7/04-评估数据集的设计/06-评估集的三个来源.md`
153. `chapter7/04-评估数据集的设计/README.md`
154. `chapter7/05-自动化评估方法/01-LLM-as-a-Judge：自动化评估的核心.md`
155. `chapter7/05-自动化评估方法/02-失败归因：从整条轨迹定位首个错误.md`
156. `chapter7/05-自动化评估方法/03-端到端回归任务与轨迹前缀回归任务.md`
157. `chapter7/05-自动化评估方法/04-配对比较与模型排名.md`
158. `chapter7/05-自动化评估方法/README.md`
159. `chapter7/06-评估驱动的模型选型/01-选型的关键维度.md`
160. `chapter7/06-评估驱动的模型选型/02-模型的行为策略.md`
161. `chapter7/06-评估驱动的模型选型/03-Agent系统的成本分析.md`
162. `chapter7/06-评估驱动的模型选型/04-评估驱动的持续迭代.md`
163. `chapter7/06-评估驱动的模型选型/README.md`
164. `chapter7/07-评估结果的统计显著性/README.md`
165. `chapter7/08-Agent的可观测性/README.md`
166. `chapter7/09-从Benchmark报告到系统改进/01-读懂Benchmark报告：发现问题的艺术.md`
167. `chapter7/09-从Benchmark报告到系统改进/02-从数据到假设：构建改进路线图.md`
168. `chapter7/09-从Benchmark报告到系统改进/03-从结果到决策：数据驱动的权衡.md`
169. `chapter7/09-从Benchmark报告到系统改进/04-持续迭代：从第一次改进到系统演化.md`
170. `chapter7/09-从Benchmark报告到系统改进/README.md`
171. `chapter7/10-从外部评估到内部评估：生产级Agent的评估基础设施/01-消融基础设施：理解每个特性的真实贡献.md`
172. `chapter7/10-从外部评估到内部评估：生产级Agent的评估基础设施/02-AB测试方法论：区分机制与目标.md`
173. `chapter7/10-从外部评估到内部评估：生产级Agent的评估基础设施/03-双层特性开关系统.md`
174. `chapter7/10-从外部评估到内部评估：生产级Agent的评估基础设施/04-提示词敏感性评估.md`
175. `chapter7/10-从外部评估到内部评估：生产级Agent的评估基础设施/05-以隐私感知分析为评估基础.md`
176. `chapter7/10-从外部评估到内部评估：生产级Agent的评估基础设施/06-从外部到内部：评估思维的转变.md`
177. `chapter7/10-从外部评估到内部评估：生产级Agent的评估基础设施/README.md`
178. `chapter7/11-仿真环境：从评估到后训练的桥梁/01-保真度权衡与领域随机化.md`
179. `chapter7/11-仿真环境：从评估到后训练的桥梁/README.md`
180. `chapter8/01-从预训练到RL：四阶段全景/01-预训练在做什么：预测下一个词.md`
181. `chapter8/01-从预训练到RL：四阶段全景/02-Mid-training的本质：在目标分布上继续学习.md`
182. `chapter8/01-从预训练到RL：四阶段全景/03-SFT的本质：换了数据的“预测下一个词”.md`
183. `chapter8/01-从预训练到RL：四阶段全景/04-什么时候需要先补底座，再做SFT-RL.md`
184. `chapter8/01-从预训练到RL：四阶段全景/05-SFT与RL的本质区别.md`
185. `chapter8/01-从预训练到RL：四阶段全景/README.md`
186. `chapter8/02-从经典RLAgent到现代Agent`[可选阅读]`/01-Agent与环境的交互.md`
187. `chapter8/02-从经典RLAgent到现代Agent`[可选阅读]`/02-两种动作表示：经典RL设置与LLM的变长策略.md`
188. `chapter8/02-从经典RLAgent到现代Agent`[可选阅读]`/README.md`
189. `chapter8/03-模型预训练基础`[可选阅读]`/README.md`
190. `chapter8/04-Mid-training：补知识与基础能力/01-Mid-training数据如何构造.md`
191. `chapter8/04-Mid-training：补知识与基础能力/README.md`
192. `chapter8/05-SFT（监督微调）/README.md`
193. `chapter8/06-SFT数据合成：从示范到可训练轨迹/README.md`
194. `chapter8/07-何时选择Mid-training、SFT与RL/README.md`
195. `chapter8/08-单轮强化学习：记忆与泛化的对照/README.md`
196. `chapter8/09-RL算法：从16次rollout到一次参数更新/01-为什么LLMRL通常优先On-Policy.md`
197. `chapter8/09-RL算法：从16次rollout到一次参数更新/README.md`
198. `chapter8/10-RL环境：从评估到仿真/01-环境：模型练习的场地.md`
199. `chapter8/10-RL环境：从评估到仿真/02-造不出环境怎么办：让模型扮演环境.md`
200. `chapter8/10-RL环境：从评估到仿真/03-环境、任务分布与评估隔离.md`
201. `chapter8/10-RL环境：从评估到仿真/README.md`
202. `chapter8/11-从单轮到多轮：任务场景与信用分配/01-多轮任务的核心挑战.md`
203. `chapter8/11-从单轮到多轮：任务场景与信用分配/02-工具调用：把环境带进Agent.md`
204. `chapter8/11-从单轮到多轮：任务场景与信用分配/README.md`
205. `chapter8/12-奖励设计：如何把任务目标变成学习信号/01-奖励来自哪里：规则、人类偏好与模型评判.md`
206. `chapter8/12-奖励设计：如何把任务目标变成学习信号/02-奖励在什么时候给：结果还是过程.md`
207. `chapter8/12-奖励设计：如何把任务目标变成学习信号/03-奖励需要表达多少信息：标量、向量与生成式诊断.md`
208. `chapter8/12-奖励设计：如何把任务目标变成学习信号/04-结果正确还不够：路径约束与RLVP.md`
209. `chapter8/12-奖励设计：如何把任务目标变成学习信号/README.md`
210. `chapter8/13-蒸馏：提升样本效率/01-在轨蒸馏：让一次rollout产生密集监督.md`
211. `chapter8/13-蒸馏：提升样本效率/02-没有更强的教师怎么办：On-Policy自蒸馏.md`
212. `chapter8/13-蒸馏：提升样本效率/README.md`
213. `chapter8/14-从问题案例到后训练/01-案例1：CodingAgent过早结束.md`
214. `chapter8/14-从问题案例到后训练/02-案例2：中文引号.md`
215. `chapter8/14-从问题案例到后训练/03-案例3：编辑文件经常失败.md`
216. `chapter8/14-从问题案例到后训练/README.md`
217. `chapter8/15-后训练实践要点/README.md`
218. `chapter9/01-从运行轨迹中获得学习信号/README.md`
219. `chapter9/02-Agent持续进化的四种方法/01-将经验沉淀为知识.md`
220. `chapter9/02-Agent持续进化的四种方法/02-将经验写成指令.md`
221. `chapter9/02-Agent持续进化的四种方法/03-将经验写成程序.md`
222. `chapter9/02-Agent持续进化的四种方法/04-将经验写入参数.md`
223. `chapter9/02-Agent持续进化的四种方法/05-从更新产物到更新“更新方法”.md`
224. `chapter9/02-Agent持续进化的四种方法/README.md`
225. `chapter9/03-构建可长期运行的持续进化闭环/01-可验证闭环的边界：当“完成”不等于“进步”.md`
226. `chapter9/03-构建可长期运行的持续进化闭环/02-持续进化的安全边界.md`
227. `chapter9/03-构建可长期运行的持续进化闭环/03-睡眠学习：整合、遗忘与能力保鲜.md`
228. `chapter9/03-构建可长期运行的持续进化闭环/README.md`
229. `chapter10/01-多Agent协作的分类框架/01-维度一：上下文是否共享.md`
230. `chapter10/01-多Agent协作的分类框架/02-维度二：协作拓扑.md`
231. `chapter10/01-多Agent协作的分类框架/README.md`
232. `chapter10/02-多Agent何时真正优于单Agent/README.md`
233. `chapter10/03-共享上下文的多Agent协作/README.md`
234. `chapter10/04-不共享上下文的多Agent协作/01-Agent眼中的文件系统.md`
235. `chapter10/04-不共享上下文的多Agent协作/02-Agent间的通信与控制.md`
236. `chapter10/04-不共享上下文的多Agent协作/03-对等协作模式：相互制衡与迭代改进.md`
237. `chapter10/04-不共享上下文的多Agent协作/04-管理者模式：中心化协调.md`
238. `chapter10/04-不共享上下文的多Agent协作/05-去中心化模式.md`
239. `chapter10/04-不共享上下文的多Agent协作/06-跨组织协作：A2A协议.md`
240. `chapter10/04-不共享上下文的多Agent协作/README.md`
241. `chapter10/05-多Agent协作的失败模式/01-失败模式一：共享文件系统的并发冲突.md`
242. `chapter10/05-多Agent协作的失败模式/02-失败模式二：错误的级联放大.md`
243. `chapter10/05-多Agent协作的失败模式/03-失败模式三：同质趋同.md`
244. `chapter10/05-多Agent协作的失败模式/04-失败模式四：互相扯皮.md`
245. `chapter10/05-多Agent协作的失败模式/05-失败模式五：循环失控.md`
246. `chapter10/05-多Agent协作的失败模式/06-失败模式六：理解债与认知投降.md`
247. `chapter10/05-多Agent协作的失败模式/README.md`
248. `chapter10/06-Agent社会/01-斯坦福AI小镇：生成式Agent的社会模拟.md`
249. `chapter10/06-Agent社会/02-Agentopia：十年尺度的长期生活模拟.md`
250. `chapter10/06-Agent社会/03-Moltbook：当Agent拥有自己的社交网络.md`
251. `chapter10/06-Agent社会/04-从虚拟社会到经济竞争：Vending-BenchArena.md`
252. `chapter10/06-Agent社会/05-Agent经济：Pinchwork与RentAHuman.md`
253. `chapter10/06-Agent社会/06-信息不对称下的策略博弈：狼人杀.md`
254. `chapter10/06-Agent社会/README.md`

---

## 01-观察空间与动作空间：模型与世界的接口.md

> 原文件：`notes/chapter1/01-现代Agent=LLM+上下文+工具/01-观察空间与动作空间：模型与世界的接口.md`
...
> 原文件：`notes/chapter1/01-现代Agent=LLM+上下文+工具/02-工具：Agent的手脚.md`
...
> 原文件：`notes/chapter1/01-现代Agent=LLM+上下文+工具/03-LLM：Agent的大脑.md`
...
> 原文件：`notes/chapter1/01-现代Agent=LLM+上下文+工具/04-上下文：Agent的眼睛.md`
...
> 原文件：`notes/chapter1/01-现代Agent=LLM+上下文+工具/05-ReAct循环.md`
...
> 原文件：`notes/chapter1/01-现代Agent=LLM+上下文+工具/README.md`

# 现代 Agent = LLM + 上下文 + 工具

> 来源：https://raw.githubusercontent.com/bojieli/ai-agent-book/main/book/chapter1.md
...
## 01-从提示工程到Loop工程：工程范式的演进.md

> 原文件：`notes/chapter1/02-Harness工程：模型之外的竞争力/01-从提示工程到Loop工程：工程范式的演进.md`
...
## 02-构建有效Agent的核心原则.md

> 原文件：`notes/chapter1/02-Harness工程：模型之外的竞争力/02-构建有效Agent的核心原则.md`
...
> 原文件：`notes/chapter1/02-Harness工程：模型之外的竞争力/03-如何选择模型.md`
...
> 原文件：`notes/chapter1/02-Harness工程：模型之外的竞争力/04-编排模式：工作流与自主.md`
...
> 原文件：`notes/chapter1/02-Harness工程：模型之外的竞争力/05-护栏与安全性.md`
...
## 06-Harness五要素与「构建」部分的对应.md

> 原文件：`notes/chapter1/02-Harness工程：模型之外的竞争力/06-Harness五要素与「构建」部分的对应.md`
...
> 原文件：`notes/chapter1/02-Harness工程：模型之外的竞争力/README.md`
...
1. [从提示工程到 Loop 工程：工程范式的演进](./01-从提示工程到Loop工程：工程范式的演进.md)
2. [构建有效 Agent 的核心原则](./02-构建有效Agent的核心原则.md)
3. [如何选择模型](./03-如何选择模型.md)
4. [编排模式：工作流与自主](./04-编排模式：工作流与自主.md)
5. [护栏与安全性](./05-护栏与安全性.md)
6. [Harness 五要素与「构建」部分的对应](./06-Harness五要素与「构建」部分的对应.md)
...
> 原文件：`notes/chapter1/03-贯穿全书的设计模式/README.md`
...
> 原文件：`notes/chapter2/01-上下文决定Agent能力上限/README.md`
...
> 原文件：`notes/chapter2/02-Agent如何调用大模型/01-消息的四种角色.md`
...
> 原文件：`notes/chapter2/02-Agent如何调用大模型/02-单轮对话.md`
...
> 原文件：`notes/chapter2/02-Agent如何调用大模型/03-带工具调用的多轮交互.md`
...
## 04-用代码实现Agent核心循环.md

> 原文件：`notes/chapter2/02-Agent如何调用大模型/04-用代码实现Agent核心循环.md`
...
> 原文件：`notes/chapter2/02-Agent如何调用大模型/05-从API视角看上下文构成.md`
...
> 原文件：`notes/chapter2/02-Agent如何调用大模型/README.md`

# Agent 如何调用大模型：理解 API 的上下文结构

原文：https://bojieli.github.io/ai-agent-book/book/chapter2/#agent-如何调用大模型理解-api-的上下文结构

本目录按原文的小节拆分，理解 API 消息结构后，再继续学习 KV Cache 和上下文压缩会更容易。
...
> 原文件：`notes/chapter2/03-KV-Cache友好的上下文设计/01-Chat-Template.md`
...
> 原文件：`notes/chapter2/03-KV-Cache友好的上下文设计/02-KV-Cache原理与约束.md`
...
## 03-KV-Cache与Prompt-Cache.md

> 原文件：`notes/chapter2/03-KV-Cache友好的上下文设计/03-KV-Cache与Prompt-Cache.md`
...
> 原文件：`notes/chapter2/03-KV-Cache友好的上下文设计/04-缓存作为架构约束.md`
...
## 05-KV-Cache可编辑与可组合.md

> 原文件：`notes/chapter2/03-KV-Cache友好的上下文设计/05-KV-Cache可编辑与可组合.md`
...
> 原文件：`notes/chapter2/03-KV-Cache友好的上下文设计/README.md`
...
> 原文件：`notes/chapter2/04-提示工程优化系统提示词/01-语气与风格.md`
...
> 原文件：`notes/chapter2/04-提示工程优化系统提示词/02-结构化提示.md`
...
> 原文件：`notes/chapter2/04-提示工程优化系统提示词/03-流程驱动与规则堆砌.md`
...
> 原文件：`notes/chapter2/04-提示工程优化系统提示词/04-业务规则细化.md`
...
> 原文件：`notes/chapter2/04-提示工程优化系统提示词/05-Few-shot示例.md`
...
> 原文件：`notes/chapter2/04-提示工程优化系统提示词/06-工具定义设计.md`
...
> 原文件：`notes/chapter2/04-提示工程优化系统提示词/07-提示注入.md`
...
> 原文件：`notes/chapter2/04-提示工程优化系统提示词/README.md`

# 提示工程：优化系统提示词

原文：https://bojieli.github.io/ai-agent-book/book/chapter2/#提示工程优化系统提示词

系统提示词像 Agent 的“员工手册”：定义身份、规则、约束、工作流程。一个实用检验标准是：聪明的新员工读完后是否知道应该怎么做。


---

## 01-Skills领域能力的可组合单元.md

> 原文件：`notes/chapter2/05-动态提示词与Agent-Skills/01-Skills领域能力的可组合单元.md`
...
> 原文件：`notes/chapter2/05-动态提示词与Agent-Skills/02-如何编写Skill.md`
...
## 03-Skills在上下文中的位置.md

> 原文件：`notes/chapter2/05-动态提示词与Agent-Skills/03-Skills在上下文中的位置.md`
...
> 原文件：`notes/chapter2/05-动态提示词与Agent-Skills/04-Skills与工具的关系.md`
...
> 原文件：`notes/chapter2/05-动态提示词与Agent-Skills/README.md`

# 动态提示词与 Agent Skills

原文：https://bojieli.github.io/ai-agent-book/book/chapter2/#动态提示词与-agent-skills

当 Agent 能力越来越多时，把所有领域规则永久塞进 System Prompt 会造成 token 浪费和注意力稀释。Skills 通过渐进式披露，把长尾能力按需加载。
...
> 原文件：`notes/chapter2/06-Agent状态栏/01-状态栏理论基础.md`
...
> 原文件：`notes/chapter2/06-Agent状态栏/02-状态栏的构成.md`
...
> 原文件：`notes/chapter2/06-Agent状态栏/03-状态栏在上下文中的位置.md`
...
> 原文件：`notes/chapter2/06-Agent状态栏/04-状态更新与缓存代价.md`
...
> 原文件：`notes/chapter2/06-Agent状态栏/README.md`

# Agent 状态栏：通过元信息增强轨迹管理

原文：https://bojieli.github.io/ai-agent-book/book/chapter2/#agent-状态栏通过元信息增强-agent-轨迹管理

状态栏把任务进度、环境观察、工具调用计数等隐式状态提炼成模型可以直接读取的显式信息，减少它从长轨迹中反复推导状态的成本。
...
> 原文件：`notes/chapter2/07-上下文压缩策略/01-为什么需要压缩.md`
...
> 原文件：`notes/chapter2/07-上下文压缩策略/02-上下文学习的内部机制.md`
...
> 原文件：`notes/chapter2/07-上下文压缩策略/03-压缩与KV-Cache.md`
...
> 原文件：`notes/chapter2/07-上下文压缩策略/04-生产级分层压缩.md`
...
> 原文件：`notes/chapter2/07-上下文压缩策略/05-压缩策略设计原则.md`
...
> 原文件：`notes/chapter2/07-上下文压缩策略/06-隔离优于压缩.md`
...
> 原文件：`notes/chapter2/07-上下文压缩策略/README.md`

# 上下文压缩策略

原文：https://bojieli.github.io/ai-agent-book/book/chapter2/#上下文压缩策略

压缩不仅是为了不超窗口，还用于降低成本、提升信息密度，并减少长上下文中重要信息被噪声淹没的问题。
...
> 原文件：`notes/chapter3/01-用户记忆系统/01-记忆能力的评估：三层次框架.md`
...
> 原文件：`notes/chapter3/01-用户记忆系统/02-记忆的层次结构.md`
...
> 原文件：`notes/chapter3/01-用户记忆系统/03-用户记忆的四种存储格式.md`
...
## 04-进阶知识表示形态：可执行代码.md

> 原文件：`notes/chapter3/01-用户记忆系统/04-进阶知识表示形态：可执行代码.md`
...
> 原文件：`notes/chapter3/01-用户记忆系统/05-用户记忆的认知科学基础.md`
...
> 原文件：`notes/chapter3/01-用户记忆系统/06-记忆框架案例.md`
...
> 原文件：`notes/chapter3/01-用户记忆系统/07-记忆压缩与整理机制.md`
...
> 原文件：`notes/chapter3/01-用户记忆系统/08-隐私保护：日志脱敏.md`
...
> 原文件：`notes/chapter3/01-用户记忆系统/README.md`
...
> 原文件：`notes/chapter3/02-RAG基础：构建Agent的知识获取管道/01-文档分块（Chunking）.md`
...
## 02-稠密嵌入：从词汇关联到语义理解.md

> 原文件：`notes/chapter3/02-RAG基础：构建Agent的知识获取管道/02-稠密嵌入：从词汇关联到语义理解.md`
...
## 03-稀疏嵌入：精确匹配的关键词检索.md

> 原文件：`notes/chapter3/02-RAG基础：构建Agent的知识获取管道/03-稀疏嵌入：精确匹配的关键词检索.md`
...
> 原文件：`notes/chapter3/02-RAG基础：构建Agent的知识获取管道/04-混合检索：两全其美的艺术.md`
...
> 原文件：`notes/chapter3/02-RAG基础：构建Agent的知识获取管道/README.md`
...
1. [文档分块（Chunking）](./01-文档分块（Chunking）.md)
2. [稠密嵌入：从词汇关联到语义理解](./02-稠密嵌入：从词汇关联到语义理解.md)
3. [稀疏嵌入：精确匹配的关键词检索](./03-稀疏嵌入：精确匹配的关键词检索.md)
4. [混合检索：两全其美的艺术](./04-混合检索：两全其美的艺术.md)


---

## 01-结构化索引：从信息检索到知识建模.md

> 原文件：`notes/chapter3/03-超越扁平文本：知识的组织与检索/01-结构化索引：从信息检索到知识建模.md`
...
## 02-文件系统范式：用目录结构组织知识.md

> 原文件：`notes/chapter3/03-超越扁平文本：知识的组织与检索/02-文件系统范式：用目录结构组织知识.md`
...
> 原文件：`notes/chapter3/03-超越扁平文本：知识的组织与检索/03-知识应该如何更新.md`
...
## 04-智能体化RAG：将知识检索工具化的范式转变.md

> 原文件：`notes/chapter3/03-超越扁平文本：知识的组织与检索/04-智能体化RAG：将知识检索工具化的范式转变.md`
...
> 原文件：`notes/chapter3/03-超越扁平文本：知识的组织与检索/05-RAG技巧：上下文感知检索.md`
...
## 06-从数据集中提取深度知识：从信息检索到知识发现.md

> 原文件：`notes/chapter3/03-超越扁平文本：知识的组织与检索/06-从数据集中提取深度知识：从信息检索到知识发现.md`
...
> 原文件：`notes/chapter3/03-超越扁平文本：知识的组织与检索/07-前沿探索：多模态记忆.md`
...
> 原文件：`notes/chapter3/03-超越扁平文本：知识的组织与检索/README.md`
...
> 原文件：`notes/chapter4/01-工具的分类/README.md`
...
## 01-能力的表达形式：专用工具、通用执行器与Skill.md

> 原文件：`notes/chapter4/02-工具设计的通用原则/01-能力的表达形式：专用工具、通用执行器与Skill.md`
...
> 原文件：`notes/chapter4/02-工具设计的通用原则/02-工具描述的艺术.md`
...
> 原文件：`notes/chapter4/02-工具设计的通用原则/03-参数传递的保真性.md`
...
> 原文件：`notes/chapter4/02-工具设计的通用原则/README.md`

# 工具设计的通用原则

> 来源：https://raw.githubusercontent.com/bojieli/ai-agent-book/main/book/chapter4.md

## 小节

1. [能力的表达形式：专用工具、通用执行器与 Skill](./01-能力的表达形式：专用工具、通用执行器与Skill.md)
2. [工具描述的艺术](./02-工具描述的艺术.md)
3. [参数传递的保真性](./03-参数传递的保真性.md)
...
> 原文件：`notes/chapter4/03-工具生态：MCP与SkillHub/README.md`
...
> 原文件：`notes/chapter4/04-工具太多怎么办：层次化组织与主动工具发现/01-层次化组织与按需加载.md`
...
> 原文件：`notes/chapter4/04-工具太多怎么办：层次化组织与主动工具发现/02-模型原生的主动工具发现.md`
...
## 03-Skills：把工具发现变成“按需查阅”.md

> 原文件：`notes/chapter4/04-工具太多怎么办：层次化组织与主动工具发现/03-Skills：把工具发现变成“按需查阅”.md`
...
> 原文件：`notes/chapter4/04-工具太多怎么办：层次化组织与主动工具发现/README.md`
...
1. [层次化组织与按需加载](./01-层次化组织与按需加载.md)
2. [模型原生的主动工具发现](./02-模型原生的主动工具发现.md)
3. [Skills：把工具发现变成“按需查阅”](./03-Skills：把工具发现变成“按需查阅”.md)
...
> 原文件：`notes/chapter4/05-感知工具/01-多模态感知.md`
...
> 原文件：`notes/chapter4/05-感知工具/README.md`
...
> 原文件：`notes/chapter4/06-执行工具/README.md`
...
> 原文件：`notes/chapter4/07-协作工具/README.md`
...
## 01-Coding是Agent的基础能力.md

> 原文件：`notes/chapter5/01-CodingAgent/01-Coding是Agent的基础能力.md`
...
## 02-案例：从Manus到OpenClaw——通用Agent的Coding内核.md

> 原文件：`notes/chapter5/01-CodingAgent/02-案例：从Manus到OpenClaw——通用Agent的Coding内核.md`
...
## 03-CodingAgent的整体流程.md

> 原文件：`notes/chapter5/01-CodingAgent/03-CodingAgent的整体流程.md`
...
## 04-Harness工程在CodingAgent中的实践.md

> 原文件：`notes/chapter5/01-CodingAgent/04-Harness工程在CodingAgent中的实践.md`
...
> 原文件：`notes/chapter5/01-CodingAgent/05-故障与错误恢复.md`
...
## 06-CodingAgent的实现技巧.md

> 原文件：`notes/chapter5/01-CodingAgent/06-CodingAgent的实现技巧.md`
...
## 07-CodingAgent中的搜索工具.md

> 原文件：`notes/chapter5/01-CodingAgent/07-CodingAgent中的搜索工具.md`
...
## 08-CodingAgent中的文件编辑工具.md

> 原文件：`notes/chapter5/01-CodingAgent/08-CodingAgent中的文件编辑工具.md`
...
## 09-CodingAgent的安全.md

> 原文件：`notes/chapter5/01-CodingAgent/09-CodingAgent的安全.md`
...
> 原文件：`notes/chapter5/01-CodingAgent/README.md`

# Coding Agent

> 来源：https://raw.githubusercontent.com/bojieli/ai-agent-book/main/book/chapter5.md

## 小节

1. [Coding 是 Agent 的基础能力](./01-Coding是Agent的基础能力.md)
2. [案例：从 Manus 到 OpenClaw——通用 Agent 的 Coding 内核](./02-案例：从Manus到OpenClaw——通用Agent的Coding内核.md)
3. [Coding Agent 的整体流程](./03-CodingAgent的整体流程.md)
4. [Harness 工程在 Coding Agent 中的实践](./04-Harness工程在CodingAgent中的实践.md)
5. [故障与错误恢复](./05-故障与错误恢复.md)
6. [Coding Agent 的实现技巧](./06-CodingAgent的实现技巧.md)
7. [Coding Agent 中的搜索工具](./07-CodingAgent中的搜索工具.md)
8. [Coding Agent 中的文件编辑工具](./08-CodingAgent中的文件编辑工具.md)
9. [Coding Agent 的安全](./09-CodingAgent的安全.md)
...
> 原文件：`notes/chapter5/02-代码：通用Agent的元能力/01-代码作为思考工具.md`
...
> 原文件：`notes/chapter5/02-代码：通用Agent的元能力/02-代码作为业务规则的约束.md`
...
> 原文件：`notes/chapter5/02-代码：通用Agent的元能力/03-代码驱动的多媒体生成.md`
...
> 原文件：`notes/chapter5/02-代码：通用Agent的元能力/04-代码作为系统适配器.md`
...
> 原文件：`notes/chapter5/02-代码：通用Agent的元能力/05-代码作为生成式UI.md`
...
## 06-代码创造代码：Agent自举.md

> 原文件：`notes/chapter5/02-代码：通用Agent的元能力/06-代码创造代码：Agent自举.md`
...
> 原文件：`notes/chapter5/02-代码：通用Agent的元能力/README.md`
...
1. [代码作为思考工具](./01-代码作为思考工具.md)
2. [代码作为业务规则的约束](./02-代码作为业务规则的约束.md)
3. [代码驱动的多媒体生成](./03-代码驱动的多媒体生成.md)
4. [代码作为系统适配器](./04-代码作为系统适配器.md)
5. [代码作为生成式 UI](./05-代码作为生成式UI.md)
6. [代码创造代码：Agent 自举](./06-代码创造代码：Agent自举.md)
...
> 原文件：`notes/chapter6/01-模态与触发时机的扩展/README.md`
...
> 原文件：`notes/chapter6/02-异步与事件驱动：当世界主动找上门/01-为什么需要异步.md`
...
## 02-OpenClaw的事件驱动机制实现.md

> 原文件：`notes/chapter6/02-异步与事件驱动：当世界主动找上门/02-OpenClaw的事件驱动机制实现.md`
...
> 原文件：`notes/chapter6/02-异步与事件驱动：当世界主动找上门/03-事件触发工具.md`
...
> 原文件：`notes/chapter6/02-异步与事件驱动：当世界主动找上门/04-用户沟通工具.md`
...
> 原文件：`notes/chapter6/02-异步与事件驱动：当世界主动找上门/05-虚拟身份与隔离执行环境.md`
...
> 原文件：`notes/chapter6/02-异步与事件驱动：当世界主动找上门/06-事件处理机制.md`
...
> 原文件：`notes/chapter6/02-异步与事件驱动：当世界主动找上门/07-不支持原生异步时的兼容方案.md`
...
## 08-模型原生异步：GPT-6Astra.md

> 原文件：`notes/chapter6/02-异步与事件驱动：当世界主动找上门/08-模型原生异步：GPT-6Astra.md`
...
## 09-从“能接收异步消息”到“可靠处理异步任务”.md

> 原文件：`notes/chapter6/02-异步与事件驱动：当世界主动找上门/09-从“能接收异步消息”到“可靠处理异步任务”.md`
...
> 原文件：`notes/chapter6/02-异步与事件驱动：当世界主动找上门/README.md`
...
> 原文件：`notes/chapter6/03-语音：最自然的人机接口/01-交互时序：从级联到全双工.md`
...
## 02-范式一·级联流水线（Cascading）.md

> 原文件：`notes/chapter6/03-语音：最自然的人机接口/02-范式一·级联流水线（Cascading）.md`
...
## 03-范式二·端到端全模态模型（Omni）.md

> 原文件：`notes/chapter6/03-语音：最自然的人机接口/03-范式二·端到端全模态模型（Omni）.md`
...
> 原文件：`notes/chapter6/03-语音：最自然的人机接口/04-范式三·全双工交互模型.md`
...
## 05-认知时序：实时交互与深度思考.md

> 原文件：`notes/chapter6/03-语音：最自然的人机接口/05-认知时序：实时交互与深度思考.md`
...
> 原文件：`notes/chapter6/03-语音：最自然的人机接口/06-更像人的语音合成.md`
...
> 原文件：`notes/chapter6/03-语音：最自然的人机接口/README.md`
...
> 原文件：`notes/chapter6/04-ComputerUse：GUI自动化Agent/01-动作空间设计.md`
...
## 02-视觉定位（Grounding）.md

> 原文件：`notes/chapter6/04-ComputerUse：GUI自动化Agent/02-视觉定位（Grounding）.md`
...
## 03-能看动画、能听声音的ComputerUseAgent.md

> 原文件：`notes/chapter6/04-ComputerUse：GUI自动化Agent/03-能看动画、能听声音的ComputerUseAgent.md`
...
## 04-ComputerUse的世界模型.md

> 原文件：`notes/chapter6/04-ComputerUse：GUI自动化Agent/04-ComputerUse的世界模型.md`
...
> 原文件：`notes/chapter6/04-ComputerUse：GUI自动化Agent/05-移动端：生态壁垒比技术更难.md`
...
> 原文件：`notes/chapter6/04-ComputerUse：GUI自动化Agent/README.md`
...
1. [动作空间设计](./01-动作空间设计.md)
2. [视觉定位（Grounding）](./02-视觉定位（Grounding）.md)
3. [能看动画、能听声音的 Computer Use Agent](./03-能看动画、能听声音的ComputerUseAgent.md)
4. [Computer Use 的世界模型](./04-ComputerUse的世界模型.md)
5. [移动端：生态壁垒比技术更难](./05-移动端：生态壁垒比技术更难.md)
...
> 原文件：`notes/chapter6/05-机器人操作：以XLeRobot整理桌面为例/01-硬件与算法的分工.md`
...
> 原文件：`notes/chapter6/05-机器人操作：以XLeRobot整理桌面为例/02-机器人控制的基本结构.md`
...
> 原文件：`notes/chapter6/05-机器人操作：以XLeRobot整理桌面为例/03-长程规划与任务分解.md`
...
> 原文件：`notes/chapter6/05-机器人操作：以XLeRobot整理桌面为例/04-VLA控制.md`
...
> 原文件：`notes/chapter6/05-机器人操作：以XLeRobot整理桌面为例/05-VLA的局限.md`
...
> 原文件：`notes/chapter6/05-机器人操作：以XLeRobot整理桌面为例/06-世界模型.md`
...
> 原文件：`notes/chapter6/05-机器人操作：以XLeRobot整理桌面为例/07-从仿真环境到真实机器人.md`
...
> 原文件：`notes/chapter6/05-机器人操作：以XLeRobot整理桌面为例/README.md`
...
1. [硬件与算法的分工](./01-硬件与算法的分工.md)
2. [机器人控制的基本结构](./02-机器人控制的基本结构.md)
3. [长程规划与任务分解](./03-长程规划与任务分解.md)
4. [VLA 控制](./04-VLA控制.md)
5. [VLA 的局限](./05-VLA的局限.md)
6. [世界模型](./06-世界模型.md)
7. [从仿真环境到真实机器人](./07-从仿真环境到真实机器人.md)
...
> 原文件：`notes/chapter7/01-一条评估任务的解剖：τ²-bench的telecom领域/01-任务定义的四个组成部分.md`
...
> 原文件：`notes/chapter7/01-一条评估任务的解剖：τ²-bench的telecom领域/02-一次真实运行的轨迹.md`
...
> 原文件：`notes/chapter7/01-一条评估任务的解剖：τ²-bench的telecom领域/README.md`
...
1. [任务定义的四个组成部分](./01-任务定义的四个组成部分.md)
2. [一次真实运行的轨迹](./02-一次真实运行的轨迹.md)


---

## 01-技术奇观：用Pass@k看能力上限.md

> 原文件：`notes/chapter7/02-评估指标：成功的定义/01-技术奇观：用Pass@k看能力上限.md`
...
## 02-业务可靠性：关注Pass^k.md

> 原文件：`notes/chapter7/02-评估指标：成功的定义/02-业务可靠性：关注Pass^k.md`
...
> 原文件：`notes/chapter7/02-评估指标：成功的定义/README.md`
...
1. [技术奇观：用 Pass@k 看能力上限](./01-技术奇观：用Pass@k看能力上限.md)
2. [业务可靠性：关注 Pass^k](./02-业务可靠性：关注Pass^k.md)
...
> 原文件：`notes/chapter7/03-评估环境/01-五个组成要素.md`
...
## 02-人机交互型与工具调用型评估环境.md

> 原文件：`notes/chapter7/03-评估环境/02-人机交互型与工具调用型评估环境.md`
...
> 原文件：`notes/chapter7/03-评估环境/README.md`
...
1. [五个组成要素](./01-五个组成要素.md)
2. [人机交互型与工具调用型评估环境](./02-人机交互型与工具调用型评估环境.md)
...
> 原文件：`notes/chapter7/04-评估数据集的设计/01-基准设计的横向对照.md`
...
> 原文件：`notes/chapter7/04-评估数据集的设计/02-验证器.md`
...
> 原文件：`notes/chapter7/04-评估数据集的设计/03-任务的难度划分.md`
...
> 原文件：`notes/chapter7/04-评估数据集的设计/04-数据泄漏防范.md`
...
> 原文件：`notes/chapter7/04-评估数据集的设计/05-质量控制与长期维护.md`
...
> 原文件：`notes/chapter7/04-评估数据集的设计/06-评估集的三个来源.md`
...
> 原文件：`notes/chapter7/04-评估数据集的设计/README.md`
...
## 01-LLM-as-a-Judge：自动化评估的核心.md

> 原文件：`notes/chapter7/05-自动化评估方法/01-LLM-as-a-Judge：自动化评估的核心.md`
...
## 02-失败归因：从整条轨迹定位首个错误.md

> 原文件：`notes/chapter7/05-自动化评估方法/02-失败归因：从整条轨迹定位首个错误.md`
...
## 03-端到端回归任务与轨迹前缀回归任务.md

> 原文件：`notes/chapter7/05-自动化评估方法/03-端到端回归任务与轨迹前缀回归任务.md`
...
> 原文件：`notes/chapter7/05-自动化评估方法/04-配对比较与模型排名.md`
...
> 原文件：`notes/chapter7/05-自动化评估方法/README.md`
...
1. [LLM-as-a-Judge：自动化评估的核心](./01-LLM-as-a-Judge：自动化评估的核心.md)
2. [失败归因：从整条轨迹定位首个错误](./02-失败归因：从整条轨迹定位首个错误.md)
3. [端到端回归任务与轨迹前缀回归任务](./03-端到端回归任务与轨迹前缀回归任务.md)
4. [配对比较与模型排名](./04-配对比较与模型排名.md)
...
> 原文件：`notes/chapter7/06-评估驱动的模型选型/01-选型的关键维度.md`
...
> 原文件：`notes/chapter7/06-评估驱动的模型选型/02-模型的行为策略.md`
...
> 原文件：`notes/chapter7/06-评估驱动的模型选型/03-Agent系统的成本分析.md`
...
> 原文件：`notes/chapter7/06-评估驱动的模型选型/04-评估驱动的持续迭代.md`
...
> 原文件：`notes/chapter7/06-评估驱动的模型选型/README.md`
...
1. [选型的关键维度](./01-选型的关键维度.md)
2. [模型的行为策略](./02-模型的行为策略.md)
3. [Agent 系统的成本分析](./03-Agent系统的成本分析.md)
4. [评估驱动的持续迭代](./04-评估驱动的持续迭代.md)
...
> 原文件：`notes/chapter7/07-评估结果的统计显著性/README.md`
...
> 原文件：`notes/chapter7/08-Agent的可观测性/README.md`
...
## 01-读懂Benchmark报告：发现问题的艺术.md

> 原文件：`notes/chapter7/09-从Benchmark报告到系统改进/01-读懂Benchmark报告：发现问题的艺术.md`
...
## 02-从数据到假设：构建改进路线图.md

> 原文件：`notes/chapter7/09-从Benchmark报告到系统改进/02-从数据到假设：构建改进路线图.md`
...
## 03-从结果到决策：数据驱动的权衡.md

> 原文件：`notes/chapter7/09-从Benchmark报告到系统改进/03-从结果到决策：数据驱动的权衡.md`
...
## 04-持续迭代：从第一次改进到系统演化.md

> 原文件：`notes/chapter7/09-从Benchmark报告到系统改进/04-持续迭代：从第一次改进到系统演化.md`
...
> 原文件：`notes/chapter7/09-从Benchmark报告到系统改进/README.md`
...
1. [读懂 Benchmark 报告：发现问题的艺术](./01-读懂Benchmark报告：发现问题的艺术.md)
2. [从数据到假设：构建改进路线图](./02-从数据到假设：构建改进路线图.md)
3. [从结果到决策：数据驱动的权衡](./03-从结果到决策：数据驱动的权衡.md)
4. [持续迭代：从第一次改进到系统演化](./04-持续迭代：从第一次改进到系统演化.md)


---

## 01-消融基础设施：理解每个特性的真实贡献.md

> 原文件：`notes/chapter7/10-从外部评估到内部评估：生产级Agent的评估基础设施/01-消融基础设施：理解每个特性的真实贡献.md`
...
## 02-AB测试方法论：区分机制与目标.md

> 原文件：`notes/chapter7/10-从外部评估到内部评估：生产级Agent的评估基础设施/02-AB测试方法论：区分机制与目标.md`
...
> 原文件：`notes/chapter7/10-从外部评估到内部评估：生产级Agent的评估基础设施/03-双层特性开关系统.md`
...
> 原文件：`notes/chapter7/10-从外部评估到内部评估：生产级Agent的评估基础设施/04-提示词敏感性评估.md`
...
> 原文件：`notes/chapter7/10-从外部评估到内部评估：生产级Agent的评估基础设施/05-以隐私感知分析为评估基础.md`
...
## 06-从外部到内部：评估思维的转变.md

> 原文件：`notes/chapter7/10-从外部评估到内部评估：生产级Agent的评估基础设施/06-从外部到内部：评估思维的转变.md`
...
> 原文件：`notes/chapter7/10-从外部评估到内部评估：生产级Agent的评估基础设施/README.md`
...
> 原文件：`notes/chapter7/11-仿真环境：从评估到后训练的桥梁/01-保真度权衡与领域随机化.md`
...
> 原文件：`notes/chapter7/11-仿真环境：从评估到后训练的桥梁/README.md`
...
1. [保真度权衡与领域随机化](./01-保真度权衡与领域随机化.md)


---

## 01-预训练在做什么：预测下一个词.md

> 原文件：`notes/chapter8/01-从预训练到RL：四阶段全景/01-预训练在做什么：预测下一个词.md`
...
## 02-Mid-training的本质：在目标分布上继续学习.md

> 原文件：`notes/chapter8/01-从预训练到RL：四阶段全景/02-Mid-training的本质：在目标分布上继续学习.md`
...
## 03-SFT的本质：换了数据的“预测下一个词”.md

> 原文件：`notes/chapter8/01-从预训练到RL：四阶段全景/03-SFT的本质：换了数据的“预测下一个词”.md`
...
## 04-什么时候需要先补底座，再做SFT-RL.md

> 原文件：`notes/chapter8/01-从预训练到RL：四阶段全景/04-什么时候需要先补底座，再做SFT-RL.md`
...
> 原文件：`notes/chapter8/01-从预训练到RL：四阶段全景/05-SFT与RL的本质区别.md`
...
> 原文件：`notes/chapter8/01-从预训练到RL：四阶段全景/README.md`
...
1. [预训练在做什么：预测下一个词](./01-预训练在做什么：预测下一个词.md)
2. [Mid-training 的本质：在目标分布上继续学习](./02-Mid-training的本质：在目标分布上继续学习.md)
3. [SFT 的本质：换了数据的“预测下一个词”](./03-SFT的本质：换了数据的“预测下一个词”.md)
4. [什么时候需要先补底座，再做 SFT/RL](./04-什么时候需要先补底座，再做SFT-RL.md)
5. [SFT 与 RL 的本质区别](./05-SFT与RL的本质区别.md)
...
> 原文件：`notes/chapter8/02-从经典RLAgent到现代Agent`[可选阅读]`/01-Agent与环境的交互.md`
...
## 02-两种动作表示：经典RL设置与LLM的变长策略.md

> 原文件：`notes/chapter8/02-从经典RLAgent到现代Agent`[可选阅读]`/02-两种动作表示：经典RL设置与LLM的变长策略.md`
...
> 原文件：`notes/chapter8/02-从经典RLAgent到现代Agent`[可选阅读]`/README.md`
...
1. [Agent 与环境的交互](./01-Agent与环境的交互.md)
2. [两种动作表示：经典 RL 设置与 LLM 的变长策略](./02-两种动作表示：经典RL设置与LLM的变长策略.md)
...
> 原文件：`notes/chapter8/03-模型预训练基础`[可选阅读]`/README.md`
...
## 01-Mid-training数据如何构造.md

> 原文件：`notes/chapter8/04-Mid-training：补知识与基础能力/01-Mid-training数据如何构造.md`
...
> 原文件：`notes/chapter8/04-Mid-training：补知识与基础能力/README.md`
...
1. [Mid-training 数据如何构造](./01-Mid-training数据如何构造.md)
...
> 原文件：`notes/chapter8/05-SFT（监督微调）/README.md`
...
> 原文件：`notes/chapter8/06-SFT数据合成：从示范到可训练轨迹/README.md`
...
> 原文件：`notes/chapter8/07-何时选择Mid-training、SFT与RL/README.md`
...
> 原文件：`notes/chapter8/08-单轮强化学习：记忆与泛化的对照/README.md`
...
## 01-为什么LLMRL通常优先On-Policy.md

> 原文件：`notes/chapter8/09-RL算法：从16次rollout到一次参数更新/01-为什么LLMRL通常优先On-Policy.md`
...
> 原文件：`notes/chapter8/09-RL算法：从16次rollout到一次参数更新/README.md`
...
1. [为什么 LLM RL 通常优先 On-Policy](./01-为什么LLMRL通常优先On-Policy.md)
...
> 原文件：`notes/chapter8/10-RL环境：从评估到仿真/01-环境：模型练习的场地.md`
...
## 02-造不出环境怎么办：让模型扮演环境.md

> 原文件：`notes/chapter8/10-RL环境：从评估到仿真/02-造不出环境怎么办：让模型扮演环境.md`
...
> 原文件：`notes/chapter8/10-RL环境：从评估到仿真/03-环境、任务分布与评估隔离.md`
...
> 原文件：`notes/chapter8/10-RL环境：从评估到仿真/README.md`
...
1. [环境：模型练习的场地](./01-环境：模型练习的场地.md)
2. [造不出环境怎么办：让模型扮演环境](./02-造不出环境怎么办：让模型扮演环境.md)
3. [环境、任务分布与评估隔离](./03-环境、任务分布与评估隔离.md)
...
> 原文件：`notes/chapter8/11-从单轮到多轮：任务场景与信用分配/01-多轮任务的核心挑战.md`
...
## 02-工具调用：把环境带进Agent.md

> 原文件：`notes/chapter8/11-从单轮到多轮：任务场景与信用分配/02-工具调用：把环境带进Agent.md`
...
> 原文件：`notes/chapter8/11-从单轮到多轮：任务场景与信用分配/README.md`
...
1. [多轮任务的核心挑战](./01-多轮任务的核心挑战.md)
2. [工具调用：把环境带进 Agent](./02-工具调用：把环境带进Agent.md)


---

## 01-奖励来自哪里：规则、人类偏好与模型评判.md

> 原文件：`notes/chapter8/12-奖励设计：如何把任务目标变成学习信号/01-奖励来自哪里：规则、人类偏好与模型评判.md`
...
## 02-奖励在什么时候给：结果还是过程.md

> 原文件：`notes/chapter8/12-奖励设计：如何把任务目标变成学习信号/02-奖励在什么时候给：结果还是过程.md`
...
## 03-奖励需要表达多少信息：标量、向量与生成式诊断.md

> 原文件：`notes/chapter8/12-奖励设计：如何把任务目标变成学习信号/03-奖励需要表达多少信息：标量、向量与生成式诊断.md`
...
## 04-结果正确还不够：路径约束与RLVP.md

> 原文件：`notes/chapter8/12-奖励设计：如何把任务目标变成学习信号/04-结果正确还不够：路径约束与RLVP.md`
...
> 原文件：`notes/chapter8/12-奖励设计：如何把任务目标变成学习信号/README.md`
...
## 01-在轨蒸馏：让一次rollout产生密集监督.md

> 原文件：`notes/chapter8/13-蒸馏：提升样本效率/01-在轨蒸馏：让一次rollout产生密集监督.md`
...
## 02-没有更强的教师怎么办：On-Policy自蒸馏.md

> 原文件：`notes/chapter8/13-蒸馏：提升样本效率/02-没有更强的教师怎么办：On-Policy自蒸馏.md`
...
> 原文件：`notes/chapter8/13-蒸馏：提升样本效率/README.md`
...
1. [在轨蒸馏：让一次 rollout 产生密集监督](./01-在轨蒸馏：让一次rollout产生密集监督.md)
2. [没有更强的教师怎么办：On-Policy 自蒸馏](./02-没有更强的教师怎么办：On-Policy自蒸馏.md)


---

## 01-案例1：CodingAgent过早结束.md

> 原文件：`notes/chapter8/14-从问题案例到后训练/01-案例1：CodingAgent过早结束.md`
...
> 原文件：`notes/chapter8/14-从问题案例到后训练/02-案例2：中文引号.md`
...
> 原文件：`notes/chapter8/14-从问题案例到后训练/03-案例3：编辑文件经常失败.md`
...
> 原文件：`notes/chapter8/14-从问题案例到后训练/README.md`
...
1. [案例 1：Coding Agent 过早结束](./01-案例1：CodingAgent过早结束.md)
2. [案例 2：中文引号](./02-案例2：中文引号.md)
3. [案例 3：编辑文件经常失败](./03-案例3：编辑文件经常失败.md)
...
> 原文件：`notes/chapter8/15-后训练实践要点/README.md`
...
> 原文件：`notes/chapter9/01-从运行轨迹中获得学习信号/README.md`
...
> 原文件：`notes/chapter9/02-Agent持续进化的四种方法/01-将经验沉淀为知识.md`
...
> 原文件：`notes/chapter9/02-Agent持续进化的四种方法/02-将经验写成指令.md`
...
> 原文件：`notes/chapter9/02-Agent持续进化的四种方法/03-将经验写成程序.md`
...
> 原文件：`notes/chapter9/02-Agent持续进化的四种方法/04-将经验写入参数.md`
...
> 原文件：`notes/chapter9/02-Agent持续进化的四种方法/05-从更新产物到更新“更新方法”.md`
...
> 原文件：`notes/chapter9/02-Agent持续进化的四种方法/README.md`
...
1. [将经验沉淀为知识](./01-将经验沉淀为知识.md)
2. [将经验写成指令](./02-将经验写成指令.md)
3. [将经验写成程序](./03-将经验写成程序.md)
4. [将经验写入参数](./04-将经验写入参数.md)
5. [从更新产物到更新“更新方法”](./05-从更新产物到更新“更新方法”.md)


---

## 01-可验证闭环的边界：当“完成”不等于“进步”.md

> 原文件：`notes/chapter9/03-构建可长期运行的持续进化闭环/01-可验证闭环的边界：当“完成”不等于“进步”.md`
...
> 原文件：`notes/chapter9/03-构建可长期运行的持续进化闭环/02-持续进化的安全边界.md`
...
## 03-睡眠学习：整合、遗忘与能力保鲜.md

> 原文件：`notes/chapter9/03-构建可长期运行的持续进化闭环/03-睡眠学习：整合、遗忘与能力保鲜.md`
...
> 原文件：`notes/chapter9/03-构建可长期运行的持续进化闭环/README.md`
...
> 原文件：`notes/chapter10/01-多Agent协作的分类框架/01-维度一：上下文是否共享.md`
...
> 原文件：`notes/chapter10/01-多Agent协作的分类框架/02-维度二：协作拓扑.md`
...
> 原文件：`notes/chapter10/01-多Agent协作的分类框架/README.md`
...
1. [维度一：上下文是否共享](./01-维度一：上下文是否共享.md)
2. [维度二：协作拓扑](./02-维度二：协作拓扑.md)
...
> 原文件：`notes/chapter10/02-多Agent何时真正优于单Agent/README.md`
...
> 原文件：`notes/chapter10/03-共享上下文的多Agent协作/README.md`
...
> 原文件：`notes/chapter10/04-不共享上下文的多Agent协作/01-Agent眼中的文件系统.md`
...
> 原文件：`notes/chapter10/04-不共享上下文的多Agent协作/02-Agent间的通信与控制.md`
...
## 03-对等协作模式：相互制衡与迭代改进.md

> 原文件：`notes/chapter10/04-不共享上下文的多Agent协作/03-对等协作模式：相互制衡与迭代改进.md`
...
> 原文件：`notes/chapter10/04-不共享上下文的多Agent协作/04-管理者模式：中心化协调.md`
...
> 原文件：`notes/chapter10/04-不共享上下文的多Agent协作/05-去中心化模式.md`
...
> 原文件：`notes/chapter10/04-不共享上下文的多Agent协作/06-跨组织协作：A2A协议.md`
...
> 原文件：`notes/chapter10/04-不共享上下文的多Agent协作/README.md`
...
1. [Agent 眼中的文件系统](./01-Agent眼中的文件系统.md)
2. [Agent 间的通信与控制](./02-Agent间的通信与控制.md)
3. [对等协作模式：相互制衡与迭代改进](./03-对等协作模式：相互制衡与迭代改进.md)
4. [管理者模式：中心化协调](./04-管理者模式：中心化协调.md)
5. [去中心化模式](./05-去中心化模式.md)
6. [跨组织协作：A2A 协议](./06-跨组织协作：A2A协议.md)


---

## 01-失败模式一：共享文件系统的并发冲突.md

> 原文件：`notes/chapter10/05-多Agent协作的失败模式/01-失败模式一：共享文件系统的并发冲突.md`
...
> 原文件：`notes/chapter10/05-多Agent协作的失败模式/02-失败模式二：错误的级联放大.md`
...
> 原文件：`notes/chapter10/05-多Agent协作的失败模式/03-失败模式三：同质趋同.md`
...
> 原文件：`notes/chapter10/05-多Agent协作的失败模式/04-失败模式四：互相扯皮.md`
...
> 原文件：`notes/chapter10/05-多Agent协作的失败模式/05-失败模式五：循环失控.md`
...
## 06-失败模式六：理解债与认知投降.md

> 原文件：`notes/chapter10/05-多Agent协作的失败模式/06-失败模式六：理解债与认知投降.md`
...
> 原文件：`notes/chapter10/05-多Agent协作的失败模式/README.md`
...
## 01-斯坦福AI小镇：生成式Agent的社会模拟.md

> 原文件：`notes/chapter10/06-Agent社会/01-斯坦福AI小镇：生成式Agent的社会模拟.md`
...
## 02-Agentopia：十年尺度的长期生活模拟.md

> 原文件：`notes/chapter10/06-Agent社会/02-Agentopia：十年尺度的长期生活模拟.md`
...
## 03-Moltbook：当Agent拥有自己的社交网络.md

> 原文件：`notes/chapter10/06-Agent社会/03-Moltbook：当Agent拥有自己的社交网络.md`
...
## 04-从虚拟社会到经济竞争：Vending-BenchArena.md

> 原文件：`notes/chapter10/06-Agent社会/04-从虚拟社会到经济竞争：Vending-BenchArena.md`
...
## 05-Agent经济：Pinchwork与RentAHuman.md

> 原文件：`notes/chapter10/06-Agent社会/05-Agent经济：Pinchwork与RentAHuman.md`
...
## 06-信息不对称下的策略博弈：狼人杀.md

> 原文件：`notes/chapter10/06-Agent社会/06-信息不对称下的策略博弈：狼人杀.md`
...
> 原文件：`notes/chapter10/06-Agent社会/README.md`
...
1. [斯坦福 AI 小镇：生成式 Agent 的社会模拟](./01-斯坦福AI小镇：生成式Agent的社会模拟.md)
2. [Agentopia：十年尺度的长期生活模拟](./02-Agentopia：十年尺度的长期生活模拟.md)
3. [Moltbook：当 Agent 拥有自己的社交网络](./03-Moltbook：当Agent拥有自己的社交网络.md)
4. [从虚拟社会到经济竞争：Vending-Bench Arena](./04-从虚拟社会到经济竞争：Vending-BenchArena.md)
5. [Agent 经济：Pinchwork 与 RentAHuman](./05-Agent经济：Pinchwork与RentAHuman.md)
6. [信息不对称下的策略博弈：狼人杀](./06-信息不对称下的策略博弈：狼人杀.md)
